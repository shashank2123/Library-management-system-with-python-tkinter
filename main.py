...
class home_page:
    def __init__(self,master):
        ...
        self.img=ImageTk.PhotoImage(Image.open(resource_path('logo.png')))
...
class login_page:
    def __init__(self):
        ...
        self.log.iconbitmap(resource_path('lib-icon.ico'))
        self.log.geometry('600x500+500+150')
        
        self.log.maxsize(800,700)
        
        self.bg_image=ImageTk.PhotoImage(Image.open(resource_path(resource_path('bg_im4.jpg'))))
...
class Menu_page:
    def __init__(self):
        ...
        self.emp_menu.iconbitmap(resource_path('lib-icon.ico'))
        self.emp_menu.geometry('600x500+500+150')
        self.emp_menu.maxsize(800,700)
        self.bg_image=ImageTk.PhotoImage(Image.open(resource_path('bg_im3.jpg')))
        ...
        self.headingLabel.place(relx=0.25,rely=0.2, relwidth=0.5, relheight=0.5)
        self.new_book_img=ImageTk.PhotoImage(Image.open(resource_path('new_book.png')))
        ...
        self.new_std_img=ImageTk.PhotoImage(Image.open(resource_path('new_student.png')))
        ...
        self.search_img=ImageTk.PhotoImage(Image.open(resource_path('search.png')))
        ...
        self.issue_img=ImageTk.PhotoImage(Image.open(resource_path('issue.jpg')))
        ...
        self.renewal_img=ImageTk.PhotoImage(Image.open(resource_path('renewal.png')))
        ...
        self.return_img=ImageTk.PhotoImage(Image.open(resource_path('return.png')))
        ...
        self.history_img=ImageTk.PhotoImage(Image.open(resource_path('history.png')))
        ...
        self.details_img=ImageTk.PhotoImage(Image.open(resource_path('details.png')))
        ...
        self.profile_img=ImageTk.PhotoImage(Image.open(resource_path('profile.png')))
...
class new_book_page:
    def __init__(self):
        ...
        self.new_book.iconbitmap(resource_path('lib-icon.ico'))
        self.new_book.geometry('600x500+500+150')
        self.new_book.maxsize(800,700)
        self.bg_image=ImageTk.PhotoImage(Image.open(resource_path('back_im.jpg')))
...
class new_std_page:
    def __init__(self):
        ...
        self.new_student.iconbitmap(resource_path('lib-icon.ico'))
...
class search_page:
    def __init__(self):
        ...
        self.search_tk.iconbitmap(resource_path('lib-icon.ico'))
...
class issue_page:
    def __init__(self):
        ...
        self.issue_tk.iconbitmap(resource_path('lib-icon.ico'))
...
class renewal_page:
    def __init__(self):
        ...
        self.renewal_tk.iconbitmap(resource_path('lib-icon.ico'))
...
class return_page:
    def __init__(self):
        ...
        self.return_tk.iconbitmap(resource_path('lib-icon.ico'))
...
class history_page:
    def __init__(self):
        ...
        self.history_tk.iconbitmap(resource_path('lib-icon.ico'))
...
class profile_page:
    def __init__(self):
        ...
        self.profile_tk.iconbitmap(resource_path('lib-icon.ico'))
...
class fine_page:
    def __init__(self):
        ...
        self.fine_tk.iconbitmap(resource_path('lib-icon.ico'))
            ...
            if Login_page_function.get_details_by_usn(self.fine_usn_var.get())!=[]:
                ...
                if self.fine_amount_var.get().isdigit():
                    if fine>0:
                        ...
                        Login_page_function.update_fine(self.fine_usn_var.get(),0)
                        messagebox.showinfo('Message',"illegal operation ")
                else:
...
root.iconbitmap(resource_path('lib-icon.ico'))
